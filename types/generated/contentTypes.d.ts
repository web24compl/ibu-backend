...
export interface ApiAboutAbout extends Struct.SingleTypeSchema {
  ...
  attributes: {
    certificates: Schema.Attribute.Component<'shared.home-cases', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    team_2: Schema.Attribute.Component<'shared.team', false>;
    team_3: Schema.Attribute.Component<'shared.team', false>;
    textWithImage: Schema.Attribute.Component<'shared.text-with-image', false>;
...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    content_3: Schema.Attribute.Blocks;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiCareerLookingCareerLooking extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::career-looking.career-looking'
    > &
      Schema.Attribute.Private;
    points: Schema.Attribute.Component<'shared.numbers', false>;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String;
    trainingMessage: Schema.Attribute.Text;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiCareerTrainingCareerTraining
  extends Struct.SingleTypeSchema {
  collectionName: 'career_trainings';
  info: {
    description: '';
    displayName: 'Career Training';
    pluralName: 'career-trainings';
    singularName: 'career-training';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::career-training.career-training'
    > &
      Schema.Attribute.Private;
    points: Schema.Attribute.Component<'shared.numbers', false>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiCareerCareer extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Component<'shared.title-with-content', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::career.career'
...
export interface ApiContactContact extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    form: Schema.Attribute.Component<'shared.contact-form-page', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::contact.contact'
...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  attributes: {
    careerLookingUrl: Schema.Attribute.String;
    careerTrainingUrl: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiHomeHome extends Struct.SingleTypeSchema {
  ...
  attributes: {
    branches: Schema.Attribute.Component<'shared.branches-home', false>;
    cases: Schema.Attribute.Component<'shared.home-cases', false>;
    contact: Schema.Attribute.Component<'shared.contact-form-person', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    HomeBanner: Schema.Attribute.Component<'shared.home-banner', true>;
    howWeWork: Schema.Attribute.Component<'shared.how-we-work', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiReferencesReferences extends Struct.SingleTypeSchema {
  collectionName: 'references_plural';
  info: {
    description: '';
    displayName: 'References ';
    pluralName: 'references-plural';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    industries: Schema.Attribute.Component<'shared.menu-sub-item', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    short_message: Schema.Attribute.String;
    subtitle: Schema.Attribute.Text;
    title: Schema.Attribute.Text;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::career-looking.career-looking': ApiCareerLookingCareerLooking;
      'api::career-training.career-training': ApiCareerTrainingCareerTraining;
